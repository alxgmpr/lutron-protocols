...
- **Bridge ID format**: `caseta-{32-char-hex}` — opaque, server-assigned
  ...
  - Our bridge: `caseta-xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx`
...
Two bridges registered: `A0B1C2D3E4F5` (Caseta) and `A0B1C2D3E4F6` (second MAC).
